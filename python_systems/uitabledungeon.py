...
class TableDungeonWindows(ui.ScriptWindow):
	...
	def LoadElements(self):
		...
		for i in xrange(0,self.pages_view):
			...
			self.elements_dungeons["select_boss_%d"%i].SetUpVisual(RUTA_IMGS+"boss_button_1.png")
			self.elements_dungeons["select_boss_%d"%i].SetOverVisual(RUTA_IMGS+"boss_button_2.png")
			self.elements_dungeons["select_boss_%d"%i].SetDownVisual(RUTA_IMGS+"boss_button_3.png")
		...
		for i in xrange(0,self.pages_view):
			...
			self.elements_dungeons["select_boss_img_%d"%i].LoadImage(RUTA_IMGS_JEFES+FReturnInfo("img",index)+"_icon.png")
	...
	def LoadInfoExtra(self,index,index_a):
		self.img_banner.LoadImage(RUTA_IMGS_JEFES+FReturnInfo("img",index)+".png")
...
class TableDungeonListWindows(ui.ScriptWindow):
	...
	def LoadWindow(self):
		...
		for i in xrange(0,self.MAX_BAR):
			...
			self.elements_list["img_%d"%i].LoadImage(RUTA_IMGS+"borde_estadisticas.png")
